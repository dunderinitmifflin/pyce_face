...
AWS_ACCESS = 'AKIAJ7YQ463O62CNGIMQ'
AWS_SECRET = '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'
API_URL = 'https://4kawvzp5ra.execute-api.us-west-2.amazonaws.com/newstage'
...
def insert_new_face_into_db(first_name, last_name, email, rekognition_id):
    ...
    cnx = mysql.connector.connect(user='pi', host='localhost', password='*1844F2B11CCAEF3B31F573A1384F608BB6DE3DF9', database='users_db_1')
    cursor = cnx.cursor()
